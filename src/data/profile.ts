...
export const profile = {
  ...
  funFacts: [
    "Lola — the cat guiding you around this site — is Elena's own rescue, a stray who wandered into a client meeting and never left.",
...
export const catTagline = "Elena's cat · your guide";
