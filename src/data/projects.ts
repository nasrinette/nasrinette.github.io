...
export const projects: Project[] = [
  ...
  },
  {
    ...
    gallery: [
      { caption: "Sketch 1 — hand-drawn flow from order type to cart", gradient: ["#fce0d8", "#f9cbbd"], icon: PenTool, image: "/assets/interactive-menu/sketch-1.webp", fit: "contain", stage: "process" },
      { caption: "Sketch 2 — menu sets, ingredient customisation, and split payment", gradient: ["#f9cbbd", "#f6b4a2"], icon: PenTool, image: "/assets/interactive-menu/sketch-2.webp", fit: "contain", stage: "process" },
      { caption: "Sketch 3 — dietary toggles and font sizing on every screen", gradient: ["#fce0d8", "#f9cbbd"], icon: PenTool, image: "/assets/interactive-menu/sketch-3.webp", fit: "contain", stage: "process" },
      { caption: "Sketch 4 — set menus, per-dish ingredients, and a help screen", gradient: ["#f9cbbd", "#f6b4a2"], icon: PenTool, image: "/assets/interactive-menu/sketch-4.webp", fit: "contain", stage: "process" },
      { caption: "Low-fidelity prototype combining all four team sketches", gradient: ["#f9cbbd", "#f6b4a2"], icon: Smartphone, image: "/assets/interactive-menu/low-fi-prototypes.webp", stage: "process" },
      { caption: "High-fidelity prototype — browsing to payment", gradient: ["#f6b4a2", "#f19a86"], icon: ListChecks, image: "/assets/interactive-menu/hi-fi-menu.webp" },
