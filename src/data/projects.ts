...
export const projects: Project[] = [
  ...
  },
  {
    ...
    gallery: [
      { caption: "Tell Claude what you ate and it lands in the dashboard, macros and all", gradient: ["#f7dfb8", "#f2cf9b"], icon: MessageSquare },
  ...
  },
  {
    ...
    highlights: [
      ...
      "Paste any text, pick a level, get five kinds of exercise, and the layout never changes on you",
